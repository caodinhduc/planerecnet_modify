...
parser.add_argument('--train_info', default='fine_650.json', type=str,
...
loss_types = ['ins', 'lav', 'cat', 'dpt', 'pln', 'edge']
...
def train():
    ...
    prn_net(torch.zeros(1, 3, cfg.max_size, cfg.max_size).cuda(cuda_id))
    ...
    data_loader = torch.utils.data.DataLoader(dataset, args.batch_size,
                                  ...
                                  generator=torch.Generator(device='cuda:{}'.format(cuda_id)),
